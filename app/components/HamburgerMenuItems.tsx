...
const HamburgerMenuItems: React.FC<MenuItemsProps> = ({ closeMenu }) => {
  ...
  return (
    <nav className="animate-slide-in fixed right-0 top-0 z-50 flex h-screen w-64 max-w-64 flex-col gap-16 overflow-y-auto bg-white/5 pl-8 pr-0 pt-8 text-white  backdrop-blur-xl">
